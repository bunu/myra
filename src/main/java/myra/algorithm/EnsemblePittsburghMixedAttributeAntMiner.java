 ...
 */
public class EnsemblePittsburghMixedAttributeAntMiner extends PittsburghMixedAttributeAntMiner {
    ...
    public String description() {
        return "Ensemble Pittsburgh Mixed-Attribute Ant-Miner";
    }

    /**
     * <code><i>ec</i>Ant-Miner<sub>PB + HMA</sub></code> entry point.
     * 
     * @param args
	...
	EnsemblePittsburghMixedAttributeAntMiner algorithm = new EnsemblePittsburghMixedAttributeAntMiner();
        algorithm.run(args);
    }
}
