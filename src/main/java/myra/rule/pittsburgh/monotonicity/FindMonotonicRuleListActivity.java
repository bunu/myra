/*
 * FindMonotonicRuleListActivity.java
 ...
 *
 */
public class FindMonotonicRuleListActivity extends IterativeActivity<RuleList> {
	/**
     ...
     *            the current dataset.
     */
    public FindMonotonicRuleListActivity(Graph graph, Dataset dataset) {
	this.graph = graph;
	...
	MonotonicityRuleFunction function = (MonotonicityRuleFunction)CONFIG.get(DEFAULT_FUNCTION);
