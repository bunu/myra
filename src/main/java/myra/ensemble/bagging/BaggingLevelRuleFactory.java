 ...
 */
public class BaggingLevelRuleFactory extends LevelRuleFactory{
        ...
        while (ruleCovered > minimum && rule.isDiverse()) {
            ...
            while (selected == -1) {
                ...
                for (int i = 0; i < neighbours.length; i++) {
                    if (!incompatible[i] && neighbours[i] != null && baggingMask[graph.vertices()[i].attribute] == 1) {
